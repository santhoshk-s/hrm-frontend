...
function DropdownProfile({ align }) {
  const { userName, role, isAuthenticated } = useAuth(); // Get user data from hook
      ...
      >
        <div ref={dropdown}>
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
            <div className="font-medium text-gray-800">{userName || "Ultrafly"}</div>
            <div className="text-xs text-gray-500 italic">{role || "Administrator"}</div>
          </div>
          <ul>
            <li>
              <Link
