      ...
      <div
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            ...
            <h1 className="absolute left-16 top-5">Home</h1>
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <SideBatItem to="EmployeeDetail" Icon={CgProfile} title="employee details admin" />
              <SideBatItem to="leaveform" Icon={CgProfile} title="leaveform" />
              <SideBatItem to="Holidays" Icon={CgProfile} title="Holidays" />
